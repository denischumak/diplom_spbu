...
def plot_sample(
    ...
    trimmer = AutoTrimmer(trimmer_cfg)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=r"C:\Users\User\Desktop\diplom\dataset_collection\label_thanks\subject_vugar",
        help="dataset_collection root folder",
    )
    args = parser.parse_args()

    cfg_path = Path(
        r"C:\Users\User\Desktop\diplom\auto_trimmer_dataset_and_code\trimmer_cfg.json"
    )
